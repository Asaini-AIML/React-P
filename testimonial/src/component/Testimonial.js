...
const Testimonial = (props) => {
  ...
  return (
    <div className="flex flex-col w-[80vw] md:w-[800px] md:h-[500px] bg-white justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md shadow-lg transform hover:scale-105 hover:z-25">
